...
function loadData() {
    chrome.storage.local.get(['plexUrl', 'plexToken', 'movieCount', 'tvShowCount', 'episodeCount', 'moviesLibraryId', 'tvShowsLibraryId'], function (data) {
...
function fetchMovies(serverUrl, plexToken, moviesLibraryId) {
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            chrome.storage.local.set({ movieCount });
        ...
        .then(data => {
            ...
            Promise.all(promises)
                .then(() => {
                    ...
                    chrome.storage.local.set({ tvShowCount, episodeCount });
